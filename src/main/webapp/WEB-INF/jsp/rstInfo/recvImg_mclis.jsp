...
<head>
    ...
    <%
 		...
 		session.setAttribute("UID",	"MCLIS");	//로그인아이디
		...
		//parm_fdt = "20170101"; // 보고일자(시작일)
		//parm_tdt = "20180101"; // 보고일자(종료일)
		//parm_hos = "15710"; // 보고일자(종료일)
...
//		$("#I_TDT").datepicker('setDate',"2018-12-07");
		...
		$("#I_RECV").val("X");	// 미수신 결과만 조회
		dataResult(); 			// 조회
		//fnFileDown();			// 다운(1:선택다운 , 2:전체다운 , 3:수신받지 않은 결과 다운)
		downRow(3);
...
/* 		    			if(v.S018RFN == "91-STI-LSD" || 
	...
	// 	    			FileNm += downName+"."+file_ext+";";
			        	...
			        	//downloadZipReport(viewerUrl, mrd_path+mrd_file, param, rdServerSaveDir, systemDownDir, downName, file_ext,resultList[idx],resultList[0].DPI300_HOS);
...
<!--<body onLoad="setTimeout('WinClose();', 60000)">--> <!-- 1초 = 1000 -->
<!-- <body> -->
						...
						<div class="srch_box_inner">
							<div class="srch_item srch_item_v3">
								...
								<div class="select_area">
									...
									<input type="hidden" id="I_RECV_YN" name="I_RECV_YN" value="O">
								</div>
							</div>
						</div>
