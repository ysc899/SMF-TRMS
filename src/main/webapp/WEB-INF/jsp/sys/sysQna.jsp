...
<head>
    ...
    <script type="text/javascript">
		...
		$(document).ready( function(){
	        ...
	        $('#searchType').html(searchWord);
	        jcf.replace($("#searchType"));
		...
		function setGrid()
		{
			...
			var columns=[
                 {name:"S015SEQ",   fieldName:"S015SEQ",   renderer:{showTooltip: true},  header:{text:"번호"},    	width:80, styles: {textAlignment: "far"}}
                ...
                ,{name:"S015CNM",   fieldName:"S015CNM",   renderer:{showTooltip: true},  header:{text:"작성자"},   	width:100}
		...
		function dataResult(){
			...
			ajaxCall("/sysQnaList.do", formData);
		}

		function onResult(strUrl,response){
 			if(strUrl == "/sysQnaList.do"){
			    ...
			    <div class="con_section row">
			    	...
			    	<div class="col-md-12 srch_box">
						...
						<div class="srch_box_inner m-t-10">
                			<div class="srch_item">
                				<div class="select_area">
                					<select id="searchType" name="searchType" class="form-control"></select>
                				</div>
                				<input type="text" class="srch_put" style="width:336px;" id="searchValue" name="searchValue" onKeydown="if(event.keyCode==13) dataResult()" maxlength = "40" >
                			</div>
                			<div class="srch_item">
