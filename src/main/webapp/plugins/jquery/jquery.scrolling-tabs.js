 ...
 // })('smartresize');
  ...
  (function (p) {
      ...
      p.setElementReferences = function (settings) {
        ...
        var arrowArea  = $tabsContainer.find('.arrowArea');
        
        $leftArrow = arrowArea.find('.scrtabs-js-tab-scroll-arrow-left');
        $rightArrow = arrowArea.find('.scrtabs-js-tab-scroll-arrow-right');
  ...
  var tabElements = (function () {
    ...
    function getNewElScrollerElementWrappingNavTabsInstance($navTabsInstance, settings) {
      var $tabsContainer = $('<div class="scrtabs-tab-container"></div>'),
          ...
          $arrowArea = $('<div class="arrowArea"></div>'),
      ...
      return $tabsContainer.append($fixedContainer.append($movableContainer.append($navTabsInstance)), $arrowArea.append($leftArrow, $rightArrow));
    }
