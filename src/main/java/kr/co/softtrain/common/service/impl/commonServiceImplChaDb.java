...
@Service("commonServiceChaDb")
public class commonServiceImplChaDb extends EgovAbstractServiceImpl implements commonServiceChaDb {
...
//	private commonMapper commonMapper;
	 ...
	 */
	@Autowired
	@Resource(name="sqlSessionChaDb")
	private SqlSessionFactory sqlSessionFactory;

	/*Transaction 관리를 위한 변수*/
	@Autowired
	@Resource(name="transactionManagerChaDb")
