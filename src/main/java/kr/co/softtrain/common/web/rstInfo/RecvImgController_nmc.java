 ...
 */
@Controller
public class RecvImgController_nmc  {
	 ...
	 * @return 
	 */
	@RequestMapping(value = "/recvImg_nmc.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String gorecvImg(HttpServletRequest request, HttpSession session) throws Exception {
		String str = "rstInfo/recvImg_nmc";
	 ...
	 * @return 
	 */
	@RequestMapping(value = "/recvImgDown_nmc.do", method = {RequestMethod.GET, RequestMethod.POST})
	public String recvImgDown(HttpServletRequest request, HttpSession session){
		String str = "rstInfo/recvImgDown_nmc";
		return str;
	}
	 ...
	 */
	/*@ResponseBody
	@RequestMapping(value = "/recvImgList_nmc.do" , method = {RequestMethod.GET, RequestMethod.POST})// , produces="application/json;charset=UTF-8")
	public Object getRecvImgList(HttpServletRequest request, HttpSession session) throws Exception {
        ...
        //MWW03T12
	  	commonService.commonOne("MWW03T12_nmc", param);
        
	  	List<Map<String, Object>> resultList = commonService.commonList("recvImgList_nmc", param);
