...
// !
public final class DpcOfMCPATBAS2 extends AbstractDpc {
	/**
	 * 메소드 설명을 삽입하십시오. 작성 날짜: (2005-03-16 오전 10:30:33)
	 */
	public DpcOfMCPATBAS2() {
		lib = "MCLISOLIB";
		pgm = "MCPATBAS2";
		parm = new DPCParameter(22);
		setCheckField(21);
	}
	...
	public void setParameters(Object[] parameters) {
		try {
			...
			parm.setParm(index++, 0, DPCParameter.Pack, 7.2); // 총뇨량
			parm.setParm(index++, 0, DPCParameter.Pack, 7.3); // 신장
