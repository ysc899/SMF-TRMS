...
/*
 엑셀
 */
public class DownloadOnnuri extends ResultDownload {
	boolean debug = false;
	...
	public DownloadOnnuri(String id, String fdat, String tdat, Boolean isRewrite) {
		setId(id);
		setfDat(fdat);
		settDat(tdat);
...
//						}
					...
					if (!isTxtRltB
							...
							&& !hosCode[i].trim().equals("24434")&& !hosCode[i].trim().equals("29167")	&& !hosCode[i].trim().equals("22256")&& !hosCode[i].trim().equals("22015")
							...
							&& !hosCode[i].trim().equals("26454")&& !hosCode[i].trim().equals("22721")&& !hosCode[i].trim().equals("")
...
//						System.out.println(rcvNo[i]+inspectCode[i]+"yty");
						...
						if (!isTxtRltB
								...
								&& inspectCode[i].trim().length() == 7
								&& (inspectCode[i].trim().substring(0, 5).equals("31001")||inspectCode[i].trim().substring(0, 5).equals("21380")
									||inspectCode[i].trim().substring(0, 5).equals("21677")||inspectCode[i].trim().substring(0, 5).equals("00901"))) { // 단독
				...
				if (hosCode[i].trim().equals("12657")
						&& (inspectCode[i].trim().substring(0, 5).indexOf("0030") == 0 || inspectCode[i].trim().substring(0, 5).indexOf("0031") == 0
								...
								|| inspectCode[i].trim().substring(0, 5).equals("71002") || inspectCode[i].trim().substring(0, 5).equals("21686") 
								|| inspectCode[i].trim().substring(0, 5).equals("71003") || inspectCode[i].trim().substring(0, 5).equals("21685") 
...
//		System.out.println("test");
	...
	private boolean is24580_24080(String[] hosCode, int i) {
		return hosCode[i].trim().equals("24580") || hosCode[i].trim().equals("24080")
				...
				|| hosCode[i].trim().equals("27993") || hosCode[i].trim().equals("28272")|| hosCode[i].trim().equals("30099")
