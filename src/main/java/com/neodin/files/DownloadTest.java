...
/**
 * 유형 설명을 삽입하십시오. 작성 날짜: (2009-01-06 오후 6:11:17)
 * 
 * @작성자: Administrator
 */
public class DownloadTest extends ResultDownload {
	boolean debug = false;
	/**
	 * DownloadTest 생성자 주석.
	 */
	...
	public DownloadTest(String id, String fdat, String tdat,
			Boolean isRewrite) {
		setId(id);
		setfDat(fdat);
		settDat(tdat);
...
//		getDpc().put("리마크2", new DpcMCR03RMS76());
		...
		getDpc().put("결과", new DpcMCR003RMR3());
		...
		try {
			int i = dpcparameter.getIntParm(34);
			...
			getDownloadData().put("결과길이", Common.getArrayTypeData_CheckLast(dpcparameter.getStringParm(18), i));
			getDownloadData().put("결과상태", Common.getArrayTypeData(dpcparameter.getStringParm(19), 1, i));
			getDownloadData().put("리마크코드", Common.getArrayTypeData(dpcparameter.getStringParm(20), 7, i));
			getDownloadData().put("검사완료일", Common.getArrayTypeData(dpcparameter.getStringParm(21), 8, i));
			getDownloadData().put("처방일자", Common.getArrayTypeData(dpcparameter.getStringParm(22), 8, i));
			getDownloadData().put("이력", Common.getArrayTypeData(dpcparameter.getStringParm(23), 3, i));
			getDownloadData().put("언어", Common.getArrayTypeData(dpcparameter.getStringParm(24), 1, i));
			getDownloadData().put("보험코드", Common.getArrayTypeData(dpcparameter.getStringParm(25), 10, i));
			getDownloadData().put("결과타입", Common.getArrayTypeData(dpcparameter.getStringParm(26), 1, i));
			getDownloadData().put("외래구분", Common.getArrayTypeData(dpcparameter.getStringParm(27), 1, i));
			getDownloadData().put("병원검체코드", Common.getArrayTypeData(dpcparameter.getStringParm(28), 5, i));
			getDownloadData().put("병원검사코드", Common.getArrayTypeData(dpcparameter.getStringParm(29), 20, i));
			getDownloadData().put("요양기관번호", Common.getArrayTypeData(dpcparameter.getStringParm(30), 20, i));
			getDownloadData().put("이미지여부", Common.getArrayTypeData(dpcparameter.getStringParm(31), 8, i)); // 내원번호
			getDownloadData().put("주민번호", Common.getArrayTypeData_CheckLast(dpcparameter.getStringParm(32),i));
			getDownloadData().put("참고치단위등", Common.getArrayTypeData_CheckLast(dpcparameter.getStringParm(33), i));
			getDownloadData().put("처방번호", Common.getArrayTypeData_CheckLast(dpcparameter.getStringParm(35), i));
		} catch (Exception _ex) {
		}
	}
