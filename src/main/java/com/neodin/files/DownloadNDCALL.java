 ...
 */
public class DownloadNDCALL extends ResultDownload {
	boolean debug = false;
	public DownloadNDCALL() {
		initialize();
	}
	...
	public DownloadNDCALL(String id, String fdat, String tdat, Boolean isRewrite) {
		setId(id);
		setfDat(fdat);
		settDat(tdat);
		...
		try {
			...
			for (int i = 0; i < cnt; i++) {
				...
				if (resultType[i].trim().equals("C")) {
					...
					//72183  72182  00687  00688  00689  11052
					if (!isTxtRltB
					...
					if (!isTxtRltB
							...
							&& (
									inspectCode[i].trim().substring(0, 5).equals("00687")||inspectCode[i].trim().substring(0, 5).equals("00688")||inspectCode[i].trim().substring(0, 5).equals("00689")
									||inspectCode[i].trim().substring(0, 5).equals("21628")||inspectCode[i].trim().substring(0, 5).equals("21628")||inspectCode[i].trim().substring(0, 5).equals("21630")||inspectCode[i].trim().substring(0, 5).equals("21631")
...
//						System.out.println( data[36]);
					...
					if (!isTxtRltB && hosCode[i].trim().equals("23401") &&(inspectCode[i].trim().substring(0, 5).equals("21154"))) {
				 ...
				 */
					...
					//컬쳐&센시 합치기
					if (!isTxtRltC && (hosCode[i].trim().equals("25382")||hosCode[i].trim().equals("23906")||hosCode[i].trim().equals("28668")||hosCode[i].trim().equals("27995")) && (inspectCode[i].trim().equals("31010"))) {
						isTxtRltC = true;
