...
public final class DpcMCR003RMR3 extends AbstractDpc {

	public DpcMCR003RMR3() {
		lib = "MCLISOLIB";
		pgm = "MCR003RMR3";
	...
	public void setParameters(Object parameters[]) {
		try {
			...
			parm.setParm(18, "", (short) 1, 1200D); // 결과길이
			parm.setParm(19, "", (short) 1, 400D); // 판정
			parm.setParm(20, "", (short) 1, 2800D); // 리마크코드
			parm.setParm(21, "", (short) 1, 3200D); // 보고일자

			// !
			parm.setParm(22, "", (short) 1, 1600D); // 처방일자
			parm.setParm(23, "", (short) 1, 1200D); // 참고치이력
			parm.setParm(24, "", (short) 1, 400D); // 참고치언어
			parm.setParm(24, "", (short) 1, 4000D); // 보험코드
			parm.setParm(26, "", (short) 1, 400D); // 결과형태
			parm.setParm(27, "", (short) 1, 400D); // 외래구분
			parm.setParm(28, "", (short) 1, 2000D); // 결과전송개수
			parm.setParm(29, "", (short) 1, 8000D); // 타병원감서코드

			// !
			parm.setParm(30, "", (short) 1, 8000D); // 요양기관번호

			// !
			parm.setParm(31, "", (short) 1, 3200D); // 내원번호

			// !
			parm.setParm(32, "", (short) 1, 8400D); // 주민번호
			parm.setParm(33, "", (short) 1, 24400D); // 참고치
			parm.setParm(34, "0", (short) 2, 5D); // 개수
			parm.setParm(35, "", (short) 1, 24400D); // 처방번호
		} catch (Exception e) {
		}
	}
