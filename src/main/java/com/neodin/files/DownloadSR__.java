...
public class DownloadSR__ extends ResultDownload {
...
//	private com.neodin.result.PatientInformation mPatientData;
	...
	public DownloadSR__(String id, String fdat, String tdat, Boolean isRewrite) {
		setId(id);
		setfDat(fdat);
		settDat(tdat);
...
//				String curNo = "";
				...
				if (!debug) {
					...
					for (int k = 0; k < data.length; k++) {
//						System.out.print(data[6] + "  " + data[7] + "  " + data[8] + " " + data[k]);
					}
				}
				row++;
			}
