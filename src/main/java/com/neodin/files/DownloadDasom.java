...
/*
 엑셀
 */
public class DownloadDasom extends ResultDownload {
	boolean debug = false;
	...
	public DownloadDasom(String id, String fdat, String tdat, Boolean isRewrite) {
		setId(id);
		setfDat(fdat);
		settDat(tdat);
	...
	public void makeDownloadFile() {
		{
			...
			row2 = 0;
				...
				try {
					...
					ArraryResult = (new String[] { "NO.", "차트번호","수진자명","진료실구분","자체코드","청구코드","검사명","접수번호",
												"처방일자","order번호","처방일련번호","내원구분","변환일자","주민번호","단문결과","장문결과","참고치" });
