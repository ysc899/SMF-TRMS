--DROP PROCEDURE WEBOBJLIB.MWR001R4;

CREATE OR REPLACE PROCEDURE WEBOBJLIB.MWR001R4
(
...
BEGIN	
   ...
   DECLARE CUR1  CURSOR WITH RETURN FOR
	...
	FROM WEBDBLIB.MWR001M@
	WHERE R001COR = I_COR
	AND (I_FDT = 0 OR R001DAT BETWEEN I_FDT AND  I_TDT)     -- 접수일자
	...
	AND (I_DAT = 0 OR  R001DAT  = I_DAT) --접수일자
	AND (I_JNO = 0 OR  R001JNO  = I_JNO) --접수번호
