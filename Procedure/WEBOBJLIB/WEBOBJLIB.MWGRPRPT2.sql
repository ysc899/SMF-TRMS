...
--  Generated on:              23/01/05 09:27:02 
--  Relational Database:       NEODIN 
--  Standards Option:          Db2 for i 
--DROP SPECIFIC PROCEDURE IF EXISTS WEBOBJLIB.MWGRPRPT2 ; 
--SET PATH "QSYS","QSYS2","SYSPROC","SYSIBMADM","NEO018" ; 
CREATE OR REPLACE PROCEDURE WEBOBJLIB.MWGRPRPT2 ( 
  IN I_PARAM VARCHAR(15000) , 
  IN I_UID VARCHAR(12) , 
  IN I_IP VARCHAR(30) ) 
  DYNAMIC RESULT SETS 1 
  LANGUAGE SQL 
  SPECIFIC WEBOBJLIB.MWGRPRPT2 
  NOT DETERMINISTIC 
  MODIFIES SQL DATA 
